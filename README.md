...
# Цели и задачи
- сравнить эффективность различных ML моделей выявлять различия между структурами `Ni-YSZ` до и после деградации (8 редокс-циклов)
...
```
# 2. Обучение VAE c CNN на 2D снимках структуры
...
## Вывод: 
Однотипные точки не кластеризуются, располагаются почти равномерно по всей площади, для решения выбранная модель и способ решения не подходит.
...
И эти графы должны обладать следующими обязательными свойствами:
...
## Вывод: 
Conditional VAE использующий на вход графы очень хорошо справился с распределением латентного пространства, все соответствующие точки сгруппированы, образцы до и после деградации находятся на существенном удалении друг от друга.
